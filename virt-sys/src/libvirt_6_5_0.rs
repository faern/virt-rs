...
pub const LIBVIR_VERSION_NUMBER: u32 = 6005000;
...
pub const VIR_CONNECT_IDENTITY_USER_NAME: &'static [u8; 10usize] = b"user-name\0";
pub const VIR_CONNECT_IDENTITY_UNIX_USER_ID: &'static [u8; 13usize] = b"unix-user-id\0";
pub const VIR_CONNECT_IDENTITY_GROUP_NAME: &'static [u8; 11usize] = b"group-name\0";
pub const VIR_CONNECT_IDENTITY_UNIX_GROUP_ID: &'static [u8; 14usize] = b"unix-group-id\0";
pub const VIR_CONNECT_IDENTITY_PROCESS_ID: &'static [u8; 11usize] = b"process-id\0";
pub const VIR_CONNECT_IDENTITY_PROCESS_TIME: &'static [u8; 13usize] = b"process-time\0";
pub const VIR_CONNECT_IDENTITY_SASL_USER_NAME: &'static [u8; 15usize] = b"sasl-user-name\0";
pub const VIR_CONNECT_IDENTITY_X509_DISTINGUISHED_NAME: &'static [u8; 24usize] =
    b"x509-distinguished-name\0";
pub const VIR_CONNECT_IDENTITY_SELINUX_CONTEXT: &'static [u8; 16usize] = b"selinux-context\0";
...
pub const VIR_MIGRATE_PARAM_TLS_DESTINATION: &'static [u8; 16usize] = b"tls.destination\0";
...
pub const VIR_DOMAIN_JOB_SUCCESS: &'static [u8; 8usize] = b"success\0";
pub const VIR_DOMAIN_JOB_ERRMSG: &'static [u8; 7usize] = b"errmsg\0";
pub const VIR_DOMAIN_JOB_DISK_TEMP_USED: &'static [u8; 15usize] = b"disk_temp_used\0";
pub const VIR_DOMAIN_JOB_DISK_TEMP_TOTAL: &'static [u8; 16usize] = b"disk_temp_total\0";
...
pub type virFreeCallback = Option<unsafe extern "C" fn(opaque: *mut ::core::ffi::c_void)>;
...
pub type virDomainGetHostnameFlags = u32;
extern "C" {
...
pub type virConnectDomainEventGenericCallback = Option<
    unsafe extern "C" fn(conn: virConnectPtr, dom: virDomainPtr, opaque: *mut ::core::ffi::c_void),
>;
...
pub type virDomainGuestInfoTypes = u32;
extern "C" {
...
pub type virDomainAgentResponseTimeoutValues = i32;
extern "C" {
...
pub type virDomainBackupBeginFlags = u32;
extern "C" {
...
pub type virEventTimeoutCallback =
    Option<unsafe extern "C" fn(timer: ::std::os::raw::c_int, opaque: *mut ::core::ffi::c_void)>;
...
pub type virConnectNetworkEventGenericCallback = Option<
    unsafe extern "C" fn(conn: virConnectPtr, net: virNetworkPtr, opaque: *mut ::core::ffi::c_void),
>;
extern "C" {
...
pub type virErrorFunc =
    Option<unsafe extern "C" fn(userData: *mut ::core::ffi::c_void, error: virErrorPtr)>;
extern "C" {
    ...
    pub fn virSetErrorFunc(userData: *mut ::core::ffi::c_void, handler: virErrorFunc);
